# -*- coding: utf-8 -*-
"""快速验证 Sales + Supplier + Verification 模块 FAIL 接口"""
import json, os
...
targets = [
    "Sales/GetCOMMODITYSALEList", "Sales/GetCOMMODITYSALEDetail",
    "Sales/GetEndaccountError",
    "Supplier/GetQUALIFICATION_HISList",
    "Verification/GetShopEndaccountSum", "Verification/GetSuppEndaccountList"
]

module_eps = {k: v for k, v in full["endpoints"].items() if k in targets}
...
tmp_path = "scripts/manifests/_tmp_ssv.json"
report_path = "docs/session4_ssv.md"

with open(tmp_path, "w", encoding="utf-8") as f:
    json.dump(mini, f, ensure_ascii=False, indent=2)

print(f"SSV manifest: {len(module_eps)} endpoints")
