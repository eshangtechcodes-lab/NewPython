...
- 总结果: `PASS 3 / FAIL 4 / SKIP 0 / TOTAL 7`
...
原 API 状态: `200`，耗时 `134.38 ms`
新 API 状态: `200`，耗时 `2136.85 ms`
...
原 API 状态: `200`，耗时 `96.79 ms`
新 API 状态: `200`，耗时 `12.61 ms`
...
原 API 状态: `200`，耗时 `90.43 ms`
新 API 状态: `200`，耗时 `51.03 ms`
...
原 API 状态: `200`，耗时 `120.6 ms`
新 API 状态: `200`，耗时 `28.37 ms`
...
原 API 状态: `415`，耗时 `5.87 ms`
新 API 状态: `200`，耗时 `19.94 ms`
