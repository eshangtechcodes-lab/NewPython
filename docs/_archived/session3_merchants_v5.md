...
原 API 状态: `200`，耗时 `158.06 ms`
新 API 状态: `200`，耗时 `2066.96 ms`
...
原 API 状态: `200`，耗时 `71.95 ms`
新 API 状态: `200`，耗时 `17.77 ms`
...
原 API 状态: `200`，耗时 `120.25 ms`
新 API 状态: `200`，耗时 `37.86 ms`
...
原 API 状态: `200`，耗时 `158.58 ms`
新 API 状态: `200`，耗时 `8.69 ms`
...
原 API 状态: `404`，耗时 `13.5 ms`
新 API 状态: `200`，耗时 `2.72 ms`
...
原 API 状态: `415`，耗时 `3.69 ms`
新 API 状态: `200`，耗时 `8.72 ms`
