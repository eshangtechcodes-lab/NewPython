...
- 总结果: `PASS 41 / FAIL 86 / SKIP 0 / TOTAL 127`
...
原 API 状态: `200`，耗时 `322.97 ms`
新 API 状态: `200`，耗时 `2221.78 ms`
...
原 API 状态: `200`，耗时 `191.44 ms`
新 API 状态: `200`，耗时 `400.84 ms`
...
| List 条数 | ✅ | 19 vs 19 |
| 首条字段集合 | ✅ | 字段一致，共 2 个 |
| 完整响应体(参考) | ✅ | 发现 25 处差异(不影响判定) |

差异明细：
- Result_Data.List[2].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_35_48_8840.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_02_22_56_26_8042.ico')
- Result_Data.List[2].node.key: 值不一致 ('1-450000' vs '1-620000')
- Result_Data.List[2].node.label: 值不一致 ('广西北部湾恒信资产经营有限公司' vs '甘肃华运高速公路服务区管理有限公司')
- Result_Data.List[2].node.value: 值不一致 (450000 vs 620000)
- Result_Data.List[3].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_45_28_6190.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_35_48_8840.png')
- Result_Data.List[3].node.key: 值不一致 ('1-650000' vs '1-450000')
- Result_Data.List[3].node.label: 值不一致 ('浙江商业集团新疆分公司' vs '广西北部湾恒信资产经营有限公司')
- Result_Data.List[3].node.value: 值不一致 (650000 vs 450000)
- Result_Data.List[4].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_58_58_0565.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_45_28_6190.png')
- Result_Data.List[4].node.key: 值不一致 ('1-630000' vs '1-650000')
- Result_Data.List[4].node.label: 值不一致 ('青海智驿服务区经营管理有限公司' vs '浙江商业集团新疆分公司')
- Result_Data.List[4].node.value: 值不一致 (630000 vs 650000)
- Result_Data.List[5].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_30_52_7437.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_10_58_58_0565.png')
- Result_Data.List[5].node.key: 值不一致 ('1-520000' vs '1-630000')
- Result_Data.List[5].node.label: 值不一致 ('贵州亨达集团建设开发有限公司' vs '青海智驿服务区经营管理有限公司')
- Result_Data.List[5].node.value: 值不一致 (520000 vs 630000)
- Result_Data.List[6].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_35_12_3219.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_30_52_7437.png')
- Result_Data.List[6].node.key: 值不一致 ('1-330300' vs '1-520000')
- Result_Data.List[6].node.label: 值不一致 ('温州高速公路资产经营公司' vs '贵州亨达集团建设开发有限公司')
- Result_Data.List[6].node.value: 值不一致 (330300 vs 520000)
- Result_Data.List[7].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_42_37_3221.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_35_12_3219.png')
- Result_Data.List[7].node.key: 值不一致 ('1-420000' vs '1-330300')
- Result_Data.List[7].node.label: 值不一致 ('湖北交投实业发展有限公司' vs '温州高速公路资产经营公司')
- Result_Data.List[7].node.value: 值不一致 (420000 vs 330300)
- Result_Data.List[8].node.ico: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_10_09_38_38_0596.png' vs 'https://user.eshangtech.com/UploadImageDir/PictureManage/10259/2020_04_09_14_42_37_3221.png')

原 API 状态: `200`，耗时 `81.91 ms`
新 API 状态: `200`，耗时 `29.36 ms`
...
原 API 状态: `200`，耗时 `96.64 ms`
新 API 状态: `200`，耗时 `18.64 ms`
...
原 API 状态: `200`，耗时 `96.84 ms`
新 API 状态: `200`，耗时 `31.09 ms`
...
原 API 状态: `200`，耗时 `96.93 ms`
新 API 状态: `200`，耗时 `47.19 ms`
...
原 API 状态: `200`，耗时 `214.97 ms`
新 API 状态: `200`，耗时 `54.08 ms`
...
原 API 状态: `200`，耗时 `275.57 ms`
新 API 状态: `200`，耗时 `98.8 ms`
...
原 API 状态: `200`，耗时 `306.16 ms`
新 API 状态: `200`，耗时 `25.09 ms`
...
原 API 状态: `200`，耗时 `134.45 ms`
新 API 状态: `200`，耗时 `62.12 ms`
...
原 API 状态: `200`，耗时 `188.14 ms`
新 API 状态: `200`，耗时 `21636.04 ms`
...
- Result_Data.List[0].OPERATE_DATE: 值不一致 ('2023/10/27 14:52:54' vs '2023-10-27T14:52:54')
...
- Result_Data.List[1].OPERATE_DATE: 值不一致 ('2023/10/27 14:53:16' vs '2023-10-27T14:53:16')
...
- Result_Data.List[2].OPERATE_DATE: 值不一致 ('2023/11/16 16:21:33' vs '2023-11-16T16:21:33')
...
- Result_Data.List[3].OPERATE_DATE: 值不一致 ('2024/2/22 10:42:23' vs '2024-02-22T10:42:23')
- Result_Data.List[4].OPERATE_DATE_End: 新 API 缺少该字段

原 API 状态: `200`，耗时 `300.3 ms`
新 API 状态: `200`，耗时 `11228.15 ms`
...
原 API 状态: `200`，耗时 `185.25 ms`
新 API 状态: `200`，耗时 `28.36 ms`
...
| 完整响应体(参考) | ✅ | 发现 24 处差异(不影响判定) |

差异明细：
- Result_Data.RtServerPartShopList[0].BusinessEndDate: 值不一致 ('2022年4月13日' vs '2022年4月12日')
- Result_Data.RtServerPartShopList[1].BusinessEndDate: 值不一致 ('2022年4月13日' vs '2022年4月12日')
- Result_Data.RtServerPartShopList[2].BusinessEndDate: 值不一致 ('2022年4月28日' vs '2022年4月27日')
- Result_Data.RtServerPartShopList[3].BusinessEndDate: 值不一致 ('2022年4月28日' vs '2022年4月27日')
- Result_Data.RtServerPartShopList[4].BusinessEndDate: 值不一致 ('2022年4月30日' vs '2022年4月29日')
- Result_Data.RtServerPartShopList[5].BusinessEndDate: 值不一致 ('2022年4月30日' vs '2022年4月29日')
- Result_Data.RtServerPartShopList[6].BusinessEndDate: 值不一致 ('2022年7月7日' vs '2022年7月6日')
- Result_Data.RtServerPartShopList[7].BusinessEndDate: 值不一致 ('2022年9月15日' vs '2022年9月14日')
- Result_Data.RtServerPartShopList[7].OperateDate: 值不一致 ('2022/9/16 20:46:02' vs '2022/9/16 20:46:2')
- Result_Data.RtServerPartShopList[8].BusinessEndDate: 值不一致 ('2022年7月21日' vs '2022年7月20日')
- Result_Data.RtServerPartShopList[9].BusinessEndDate: 值不一致 ('2022年7月6日' vs '2022年7月5日')
- Result_Data.RtServerPartShopList[11].OperateDate: 值不一致 ('2022/9/17 23:01:46' vs '2022/9/17 23:1:46')
...
- Result_Data.ShopBusinessStateList[1].TaxPayerIdEntityCode: 类型不一致 (NoneType vs str)，值为 None vs '待定'

原 API 状态: `200`，耗时 `811.37 ms`
新 API 状态: `200`，耗时 `371.21 ms`
...
- Result_Data.List[0].PROVINCE_CODE: 类型不一致 (NoneType vs int)，值为 None vs 3544

原 API 状态: `200`，耗时 `313.52 ms`
新 API 状态: `200`，耗时 `75.4 ms`
...
原 API 状态: `200`，耗时 `331.29 ms`
新 API 状态: `200`，耗时 `1474.87 ms`
...
原 API 状态: `200`，耗时 `183.7 ms`
新 API 状态: `200`，耗时 `271.17 ms`
...
原 API 状态: `200`，耗时 `105.87 ms`
新 API 状态: `200`，耗时 `93.61 ms`
...
原 API 状态: `200`，耗时 `116.23 ms`
新 API 状态: `200`，耗时 `45.95 ms`
...
原 API 状态: `200`，耗时 `309.7 ms`
新 API 状态: `200`，耗时 `87.41 ms`
...
原 API 状态: `200`，耗时 `183.03 ms`
新 API 状态: `200`，耗时 `73.97 ms`
...
原 API 状态: `200`，耗时 `381.88 ms`
新 API 状态: `200`，耗时 `389.09 ms`
...
- Result_Data.List[0].children[0].children[0].node.key: 值不一致 ('2-11363' vs '2-1019')
- Result_Data.List[0].children[0].children[0].node.label: 值不一致 ('【下塘烧饼】1' vs '新桥服务区')
- Result_Data.List[0].children[0].children[0].node.value: 值不一致 (11363 vs 1019)
- Result_Data.List[0].children[0].children[1].node.key: 值不一致 ('2-12244' vs '2-1021')
- Result_Data.List[0].children[0].children[1].node.label: 值不一致 ('【下塘烧饼】2' vs '猫屎咖啡')
- Result_Data.List[0].children[0].children[1].node.value: 值不一致 (12244 vs 1021)
- Result_Data.List[0].children[0].children[2].node.key: 值不一致 ('2-161' vs '2-1022')
- Result_Data.List[0].children[0].children[2].node.label: 值不一致 ('【围炉锅盔】围炉锅盔' vs '精品咖啡')
- Result_Data.List[0].children[0].children[2].node.value: 值不一致 (161 vs 1022)
- Result_Data.List[0].children[0].children[3].node.key: 值不一致 ('2-171' vs '2-1023')
- Result_Data.List[0].children[0].children[3].node.label: 值不一致 ('【王仁和米线】米线类' vs '经典咖啡')
- Result_Data.List[0].children[0].children[3].node.value: 值不一致 (171 vs 1023)
- Result_Data.List[0].children[0].children[4].node.key: 值不一致 ('2-172' vs '2-1024')
- Result_Data.List[0].children[0].children[4].node.label: 值不一致 ('【王仁和米线】面条类' vs '冰雪乐咖啡')
- Result_Data.List[0].children[0].children[4].node.value: 值不一致 (172 vs 1024)
- Result_Data.List[0].children[0].children[5].node.key: 值不一致 ('2-173' vs '2-1025')
- Result_Data.List[0].children[0].children[5].node.label: 值不一致 ('【王仁和米线】小吃类' vs '茶和其他')
- Result_Data.List[0].children[0].children[5].node.value: 值不一致 (173 vs 1025)
- Result_Data.List[0].children[0].children[6].node.key: 值不一致 ('2-174' vs '2-1026')
- Result_Data.List[0].children[0].children[6].node.label: 值不一致 ('【王仁和米线】其他' vs '气泡水')
- Result_Data.List[0].children[0].children[6].node.value: 值不一致 (174 vs 1026)
- Result_Data.List[0].children[0].children[7].node.key: 值不一致 ('2-175' vs '2-1027')
- Result_Data.List[0].children[0].children[7].node.label: 值不一致 ('【刘鸿盛小吃】包子系列' vs '冰淇淋')
- Result_Data.List[0].children[0].children[7].node.value: 值不一致 (175 vs 1027)

原 API 状态: `200`，耗时 `393.8 ms`
新 API 状态: `200`，耗时 `1159.75 ms`
...
- Result_Data.List[10].PROJECT_ENDDATE: 值不一致 ('2024/2/4' vs '2024-02-04T00:00:00')
- Result_Data.List[10].PROJECT_STARTDATE: 值不一致 ('2021/2/5' vs '2021-02-05T00:00:00')
- Result_Data.List[11].PROJECT_ENDDATE: 值不一致 ('2028/1/13' vs '2028-01-13T00:00:00')
- Result_Data.List[11].PROJECT_STARTDATE: 值不一致 ('2025/1/14' vs '2025-01-14T00:00:00')
- Result_Data.List[12].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[12].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[13].BUSINESSPROJECT_ICO: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10292/2021_02_03_12_03_53_4354.png' vs 'https://api.eshangtech.com/EShangApiMain/UploadImageDir/PictureManage/10292/2021_02_03_12_03_53_4354.png')
- Result_Data.List[13].PROJECT_ENDDATE: 值不一致 ('2024/1/31' vs '2024-01-31T00:00:00')
- Result_Data.List[13].PROJECT_STARTDATE: 值不一致 ('2021/2/1' vs '2021-02-01T00:00:00')
- Result_Data.List[13].SERVERPARTSHOP_ID: 值不一致 ('3047,3046' vs '3046,3047')
- Result_Data.List[14].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[14].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[15].BUSINESSPROJECT_ICO: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10292/2020_04_08_11_51_47_0248.png' vs 'https://api.eshangtech.com/EShangApiMain/UploadImageDir/PictureManage/10292/2020_04_08_11_51_47_0248.png')
- Result_Data.List[15].PROJECT_ENDDATE: 值不一致 ('2024/1/31' vs '2024-01-31T00:00:00')
- Result_Data.List[15].PROJECT_STARTDATE: 值不一致 ('2021/2/1' vs '2021-02-01T00:00:00')
- Result_Data.List[17].PROJECT_ENDDATE: 值不一致 ('2034/9/13' vs '2034-09-13T00:00:00')
- Result_Data.List[17].PROJECT_STARTDATE: 值不一致 ('2024/9/14' vs '2024-09-14T00:00:00')
...
- Result_Data.List[18].PROJECT_ENDDATE: 值不一致 ('2024/1/31' vs '2024-01-31T00:00:00')
- Result_Data.List[18].PROJECT_STARTDATE: 值不一致 ('2021/2/1' vs '2021-02-01T00:00:00')
- Result_Data.List[19].BUSINESSPROJECT_ICO: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10292/2021_02_03_15_41_35_3219.png' vs 'https://api.eshangtech.com/EShangApiMain/UploadImageDir/PictureManage/10292/2021_02_03_15_41_35_3219.png')
- Result_Data.List[19].SERVERPARTSHOP_ID: 值不一致 ('3057,3056' vs '3056,3057')
- Result_Data.List[20].BUSINESSPROJECT_ICO: 值不一致 ('https://user.eshangtech.com/UploadImageDir/PictureManage/10292/2021_02_03_15_41_35_3219.png' vs 'https://api.eshangtech.com/EShangApiMain/UploadImageDir/PictureManage/10292/2021_02_03_15_41_35_3219.png')
- Result_Data.List[20].PROJECT_ENDDATE: 值不一致 ('2027/2/14' vs '2027-02-14T00:00:00')

原 API 状态: `200`，耗时 `551.73 ms`
新 API 状态: `200`，耗时 `1430.9 ms`
...
原 API 状态: `200`，耗时 `91.64 ms`
新 API 状态: `200`，耗时 `184.81 ms`
...
差异明细：
- Result_Data.List[0].children: 列表长度不一致 (3 vs 6)
- Result_Data.List[0].children[0].children: 类型不一致 (NoneType vs list)，值为 None vs []
- Result_Data.List[0].children[0].node.BusinessTrade_ICO: 值不一致 ('https://eshangtech.com:18999//UploadImageDir/PictureManage/10260/2020_04_09_16_15_03_8224.png' vs 'https://eshangtech.com:18999//UploadImageDir/PictureManage/10260/2020_04_03_21_10_55_8858.png')
- Result_Data.List[0].children[0].node.BusinessTrade_Id: 值不一致 (258 vs 231)
- Result_Data.List[0].children[0].node.BusinessTrade_Name: 值不一致 ('卡车之家' vs '茶餐厅')
- Result_Data.List[0].children[1].children: 类型不一致 (NoneType vs list)，值为 None vs []
- Result_Data.List[0].children[1].node.BrandTreeList: 列表长度不一致 (2 vs 35)
- Result_Data.List[0].children[1].node.BrandTreeList[0].Brand_ICO: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].Brand_ID: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].Brand_Name: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].Brand_Type: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].BRAND_ID: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].BRAND_INTRO: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].BRAND_NAME: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[0].BRAND_STATE: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].Brand_ICO: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].Brand_ID: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].Brand_Name: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].Brand_Type: 新 API 缺少该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].BRAND_ID: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].BRAND_INTRO: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].BRAND_NAME: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BrandTreeList[1].BRAND_STATE: 新 API 多出该字段
- Result_Data.List[0].children[1].node.BusinessTrade_ICO: 值不一致 ('https://eshangtech.com:18999//UploadImageDir/PictureManage/10260/2020_04_09_16_25_25_2288.png' vs 'https://eshangtech.com:18999//UploadImageDir/PictureManage/10260/2020_04_03_21_11_47_2608.png')
- Result_Data.List[0].children[1].node.BusinessTrade_Id: 值不一致 (257 vs 226)

原 API 状态: `200`，耗时 `418.56 ms`
新 API 状态: `200`，耗时 `462.62 ms`
...
原 API 状态: `200`，耗时 `165.42 ms`
新 API 状态: `200`，耗时 `2334.91 ms`
...
原 API 状态: `200`，耗时 `188.12 ms`
新 API 状态: `200`，耗时 `76.6 ms`
...
原 API 状态: `200`，耗时 `247.59 ms`
新 API 状态: `200`，耗时 `72.51 ms`
...
原 API 状态: `200`，耗时 `561.92 ms`
新 API 状态: `200`，耗时 `73.27 ms`
...
| List 条数 | ✅ | 10 vs 10 |
| 首条字段集合 | ✅ | 字段一致，共 9 个 |
| 完整响应体(参考) | ✅ | 发现 10 处差异(不影响判定) |

差异明细：
- Result_Data.List[0].COMMODITY_TYPE: 值不一致 ('锅盔' vs '906')
- Result_Data.List[1].COMMODITY_TYPE: 值不一致 ('休闲食品类' vs '1134')
...
原 API 状态: `200`，耗时 `426.82 ms`
新 API 状态: `200`，耗时 `218.29 ms`
...
原 API 状态: `200`，耗时 `159.91 ms`
新 API 状态: `200`，耗时 `10563.09 ms`
...
原 API 状态: `200`，耗时 `97.12 ms`
新 API 状态: `200`，耗时 `76.05 ms`
...
原 API 状态: `200`，耗时 `224.83 ms`
新 API 状态: `200`，耗时 `102.28 ms`
...
原 API 状态: `200`，耗时 `82.51 ms`
新 API 状态: `200`，耗时 `227.02 ms`
...
原 API 状态: `415`，耗时 `4.32 ms`
新 API 状态: `200`，耗时 `340.69 ms`
...
原 API 状态: `200`，耗时 `200.59 ms`
新 API 状态: `200`，耗时 `787.13 ms`
...
- Result_Data.List[0].ACTUAL_RATIO: 类型不一致 (NoneType vs float)，值为 None vs 16.0
- Result_Data.List[0].BUSINESSPROJECT_ID: 值不一致 (32 vs 166)
- Result_Data.List[0].BUSINESSPROJECT_NAME: 值不一致 ('新桥服务区（中式餐饮）项目' vs '新桥服务区（麦当劳）项目')
- Result_Data.List[0].BUSINESS_STATE: 值不一致 (3000 vs 1000)
- Result_Data.List[0].COMMISSION_RATIO: 类型不一致 (NoneType vs float)，值为 None vs 20.0
- Result_Data.List[0].COST_AMOUNT: 类型不一致 (NoneType vs float)，值为 None vs 1175055.06

原 API 状态: `200`，耗时 `377.73 ms`
新 API 状态: `200`，耗时 `338.28 ms`
...
差异明细：
- Result_Data.List[0].label: 值不一致 ('业态缺失告警' vs '保底偏低预警')
- Result_Data.List[0].value: 值不一致 (40 vs 35)
- Result_Data.List[1].label: 值不一致 ('保底提成过高' vs '商家退场告警')
- Result_Data.List[1].pid: 值不一致 (7 vs 3)
- Result_Data.List[1].value: 值不一致 (119 vs 4)
- Result_Data.List[2].label: 值不一致 ('商家退场告警' vs '商家退场预警')
- Result_Data.List[2].pid: 值不一致 (3 vs 5)
- Result_Data.List[2].value: 值不一致 (5 vs 56)
- Result_Data.List[3].label: 值不一致 ('商家退场预警' vs '租金提成偏低')
- Result_Data.List[3].pid: 值不一致 (5 vs 6)
- Result_Data.List[3].value: 值不一致 (8 vs 48)
- Result_Data.List[4].label: 值不一致 ('租金提成偏低' vs '租金提成过高')
- Result_Data.List[4].pid: 值不一致 (6 vs 7)
- Result_Data.List[4].value: 值不一致 (54 vs 101)
- Result_Data.List[5].value: 值不一致 (103 vs 158)
- Result_Data.List[7].value: 值不一致 (35 vs 50)

原 API 状态: `200`，耗时 `308.43 ms`
新 API 状态: `200`，耗时 `48.87 ms`
...
原 API 状态: `200`，耗时 `596.49 ms`
新 API 状态: `200`，耗时 `91.16 ms`
...
原 API 状态: `200`，耗时 `207.57 ms`
新 API 状态: `200`，耗时 `15.11 ms`
...
原 API 状态: `200`，耗时 `104.28 ms`
新 API 状态: `200`，耗时 `59.97 ms`
...
原 API 状态: `200`，耗时 `197.19 ms`
新 API 状态: `200`，耗时 `229.88 ms`
...
- Result_Data.List[0].STATISTICS_DATE: 类型不一致 (str vs int)，值为 '2023/06/21' vs 20230621

原 API 状态: `200`，耗时 `364.94 ms`
新 API 状态: `200`，耗时 `303.34 ms`
...
差异明细：
- Result_Data.List[0].COOPMERCHANTS_ID_Encrypted: 值不一致 ('81CE757C9F41E414' vs '-1228')
- Result_Data.List[1].COOPMERCHANTS_ID_Encrypted: 值不一致 ('BCE492FD2EA0323B' vs '-2188')
- Result_Data.List[2].COOPMERCHANTS_ID_Encrypted: 值不一致 ('349C3AA238B5BD80' vs '-2117')
- Result_Data.List[3].COOPMERCHANTS_ID_Encrypted: 值不一致 ('B4865CDD81A8FA43' vs '-570')
- Result_Data.List[4].COOPMERCHANTS_ID_Encrypted: 值不一致 ('D6FF8926E5F04164' vs '-1286')
- Result_Data.List[5].COOPMERCHANTS_ID_Encrypted: 值不一致 ('D5D285C62DD76A8A' vs '-2116')
- Result_Data.List[6].COOPMERCHANTS_ID_Encrypted: 值不一致 ('2F9D88EB80EE113D' vs '-567')
- Result_Data.List[7].COMMISSION_RATIO: 类型不一致 (str vs NoneType)，值为 '' vs None
- Result_Data.List[7].COOPMERCHANTS_ID_Encrypted: 值不一致 ('F8244220E7345293' vs '-2863')
- Result_Data.List[8].COMMISSION_RATIO: 类型不一致 (str vs NoneType)，值为 '' vs None
- Result_Data.List[8].COOPMERCHANTS_ID_Encrypted: 值不一致 ('47A0CED9B7734825' vs '-2161')
- Result_Data.List[9].COMMISSION_RATIO: 类型不一致 (str vs NoneType)，值为 '' vs None
- Result_Data.List[9].COOPMERCHANTS_ID_Encrypted: 值不一致 ('33F829C096B84949' vs '-568')
- Result_Data.List[10].COOPMERCHANTS_ID_Encrypted: 值不一致 ('4109980445E26305' vs '-1116')
- Result_Data.List[11].COOPMERCHANTS_ID_Encrypted: 值不一致 ('8DBB8F8F1095B998' vs '-2182')
- Result_Data.List[12].COOPMERCHANTS_ID_Encrypted: 值不一致 ('8FE6A0793D3DD492' vs '-1028')
- Result_Data.List[13].COOPMERCHANTS_ID_Encrypted: 值不一致 ('E9457048F79C352D' vs '-2115')
- Result_Data.List[14].COOPMERCHANTS_ID_Encrypted: 值不一致 ('AFEB49E35C99D0F0' vs '-584')
- Result_Data.List[15].COOPMERCHANTS_ID_Encrypted: 值不一致 ('A694EB41E5E8085F' vs '-1118')
- Result_Data.List[16].COOPMERCHANTS_ID_Encrypted: 值不一致 ('D6FF8926E5F04164' vs '-1286')
- Result_Data.List[17].COOPMERCHANTS_ID_Encrypted: 值不一致 ('D6FF8926E5F04164' vs '-1286')
- Result_Data.List[18].COOPMERCHANTS_ID_Encrypted: 值不一致 ('D6FF8926E5F04164' vs '-1286')
- Result_Data.List[19].COMMISSION_RATIO: 类型不一致 (str vs NoneType)，值为 '' vs None
- Result_Data.List[19].COOPMERCHANTS_ID: 类型不一致 (str vs NoneType)，值为 '' vs None
- Result_Data.List[19].COOPMERCHANTS_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '' vs None

原 API 状态: `200`，耗时 `493.66 ms`
新 API 状态: `200`，耗时 `666.18 ms`
...
原 API 状态: `200`，耗时 `591.98 ms`
新 API 状态: `200`，耗时 `362.38 ms`
...
原 API 状态: `200`，耗时 `151.3 ms`
新 API 状态: `200`，耗时 `37.07 ms`
...
原 API 状态: `200`，耗时 `601.82 ms`
新 API 状态: `200`，耗时 `591.94 ms`
...
原 API 状态: `200`，耗时 `144.21 ms`
新 API 状态: `200`，耗时 `444.33 ms`
...
原 API 状态: `404`，耗时 `11.2 ms`
新 API 状态: `200`，耗时 `379.4 ms`
...
原 API 状态: `200`，耗时 `383.7 ms`
新 API 状态: `200`，耗时 `599.25 ms`
...
原 API 状态: `200`，耗时 `360.46 ms`
新 API 状态: `200`，耗时 `680.57 ms`
...
- Result_Data.List[0].COOPMERCHANTS_ID: 类型不一致 (str vs int)，值为 'C64BAE48506C3ACB' vs -2810
...
- Result_Data.List[1].UNDISTRIBUTED_AMOUNT: 新 API 缺少该字段
- Result_Data.List[1].ACCOUNT_AMOUNT: 类型不一致 (float vs int)，值为 1550.0 vs 0

原 API 状态: `200`，耗时 `15519.81 ms`
新 API 状态: `200`，耗时 `2191.8 ms`
...
原 API 状态: `200`，耗时 `1789.97 ms`
新 API 状态: `200`，耗时 `5.58 ms`
...
原 API 状态: `404`，耗时 `6.81 ms`
新 API 状态: `200`，耗时 `5.85 ms`
...
- Result_Data.List[0].value: 类型不一致 (float vs int)，值为 3046.0 vs 3046
- Result_Data.List[1].index: 新 API 缺少该字段
- Result_Data.List[1].type: 新 API 缺少该字段
- Result_Data.List[1].value: 类型不一致 (float vs int)，值为 3044.0 vs 3044
- Result_Data.List[2].index: 新 API 缺少该字段
- Result_Data.List[2].type: 新 API 缺少该字段
- Result_Data.List[2].value: 类型不一致 (float vs int)，值为 5298.0 vs 5298
- Result_Data.List[3].index: 新 API 缺少该字段
- Result_Data.List[3].type: 新 API 缺少该字段
- Result_Data.List[3].value: 类型不一致 (float vs int)，值为 3068.0 vs 3068
- Result_Data.List[4].index: 新 API 缺少该字段
- Result_Data.List[4].type: 新 API 缺少该字段
- Result_Data.List[4].value: 类型不一致 (float vs int)，值为 3056.0 vs 3056
...
- Result_Data.List[6].value: 类型不一致 (float vs int)，值为 3066.0 vs 3066
- Result_Data.List[7].index: 新 API 缺少该字段
- Result_Data.List[7].type: 新 API 缺少该字段
- Result_Data.List[7].label: 值不一致 ('鲜道寿司' vs '自助玩具机')

原 API 状态: `200`，耗时 `114.69 ms`
新 API 状态: `200`，耗时 `70.98 ms`
...
原 API 状态: `200`，耗时 `125.74 ms`
新 API 状态: `200`，耗时 `46.75 ms`
...
原 API 状态: `200`，耗时 `251.35 ms`
新 API 状态: `200`，耗时 `30.6 ms`
...
原 API 状态: `200`，耗时 `105.48 ms`
新 API 状态: `200`，耗时 `19.07 ms`
...
- Result_Data.List[3].MERCHANTS_IDS: 新 API 缺少该字段
- Result_Data.List[3].REGISTERCOMPACT_IDS: 新 API 缺少该字段
- Result_Data.List[3].SERVERPART_IDS: 新 API 缺少该字段

原 API 状态: `200`，耗时 `246.29 ms`
新 API 状态: `200`，耗时 `43.34 ms`
...
原 API 状态: `200`，耗时 `108.05 ms`
新 API 状态: `200`，耗时 `23.1 ms`
...
- Result_Data.List[0].SWITCH_DATE: 类型不一致 (str vs float)，值为 '2025/06/01 00:00:04' vs 20250601000004.0
...
- Result_Data.List[1].SWITCH_DATE: 类型不一致 (str vs float)，值为 '2025/08/01 00:00:40' vs 20250801000040.0
- Result_Data.List[2].BUSINESSPROJECT_ICO: 新 API 缺少该字段
- Result_Data.List[2].COMPACT_ENDDATE: 新 API 缺少该字段
- Result_Data.List[2].COMPACT_STARTDATE: 新 API 缺少该字段

原 API 状态: `200`，耗时 `148.83 ms`
新 API 状态: `200`，耗时 `19.51 ms`
...
原 API 状态: `200`，耗时 `113.3 ms`
新 API 状态: `200`，耗时 `17.05 ms`
...
原 API 状态: `500`，耗时 `5.82 ms`
新 API 状态: `200`，耗时 `510.38 ms`
...
原 API 状态: `200`，耗时 `688.6 ms`
新 API 状态: `200`，耗时 `34.4 ms`
...
原 API 状态: `200`，耗时 `352.45 ms`
新 API 状态: `200`，耗时 `17.76 ms`
...
原 API 状态: `200`，耗时 `1086.17 ms`
新 API 状态: `200`，耗时 `98.23 ms`
...
原 API 状态: `200`，耗时 `934.22 ms`
新 API 状态: `200`，耗时 `21.6 ms`
...
原 API 状态: `200`，耗时 `123.62 ms`
新 API 状态: `200`，耗时 `21.24 ms`
...
原 API 状态: `200`，耗时 `638.1 ms`
新 API 状态: `200`，耗时 `34.78 ms`
...
原 API 状态: `200`，耗时 `795.16 ms`
新 API 状态: `200`，耗时 `143.18 ms`
...
原 API 状态: `200`，耗时 `544.66 ms`
新 API 状态: `200`，耗时 `42.19 ms`
...
原 API 状态: `200`，耗时 `141.55 ms`
新 API 状态: `200`，耗时 `58.09 ms`
...
原 API 状态: `200`，耗时 `247.26 ms`
新 API 状态: `200`，耗时 `283.69 ms`
...
原 API 状态: `200`，耗时 `129.79 ms`
新 API 状态: `200`，耗时 `68.32 ms`
...
原 API 状态: `200`，耗时 `99.92 ms`
新 API 状态: `200`，耗时 `24.88 ms`
...
原 API 状态: `200`，耗时 `324.71 ms`
新 API 状态: `200`，耗时 `28.95 ms`
...
原 API 状态: `200`，耗时 `110.47 ms`
新 API 状态: `200`，耗时 `49.61 ms`
...
原 API 状态: `200`，耗时 `110.89 ms`
新 API 状态: `200`，耗时 `42.69 ms`
...
原 API 状态: `200`，耗时 `250.6 ms`
新 API 状态: `200`，耗时 `23.34 ms`
...
原 API 状态: `200`，耗时 `111.13 ms`
新 API 状态: `200`，耗时 `63.43 ms`
...
原 API 状态: `200`，耗时 `105.98 ms`
新 API 状态: `200`，耗时 `34.29 ms`
...
原 API 状态: `200`，耗时 `263.34 ms`
新 API 状态: `200`，耗时 `122.76 ms`
...
- Result_Data.ProjectMonthlyCompleteList[0].ProjectCompleteDetailList[0].Account_Amount: 类型不一致 (NoneType vs int)，值为 None vs 0
- Result_Data.ProjectMonthlyCompleteList[0].ProjectCompleteDetailList[0].Complete_Degree: 类型不一致 (float vs int)，值为 100.0 vs 100
- Result_Data.ProjectMonthlyCompleteList[0].ProjectCompleteDetailList[0].Payment_Amount: 类型不一致 (NoneType vs int)，值为 None vs 0
...
原 API 状态: `200`，耗时 `254.06 ms`
新 API 状态: `200`，耗时 `113.44 ms`
...
原 API 状态: `200`，耗时 `874.94 ms`
新 API 状态: `200`，耗时 `118.54 ms`
...
原 API 状态: `200`，耗时 `507.43 ms`
新 API 状态: `200`，耗时 `57.01 ms`
...
原 API 状态: `200`，耗时 `116.0 ms`
新 API 状态: `200`，耗时 `72.99 ms`
...
原 API 状态: `200`，耗时 `193.11 ms`
新 API 状态: `200`，耗时 `45.52 ms`
...
原 API 状态: `200`，耗时 `358.59 ms`
新 API 状态: `200`，耗时 `68.61 ms`
...
- Result_Data.List[0].BUSINESS_TRADE: 类型不一致 (int vs NoneType)，值为 1 vs None
...
- Result_Data.List[2].BUSINESS_TRADE: 类型不一致 (int vs NoneType)，值为 2 vs None
- Result_Data.List[2].COMPACT_AMOUNT: 值不一致 (90.0 vs 10.0)
- Result_Data.List[2].COMPACT_CHILDTYPE: 类型不一致 (int vs NoneType)，值为 1 vs None
- Result_Data.List[2].COMPACT_CODE: 值不一致 ('' vs 'sp-202401')
- Result_Data.List[2].COMPACT_ENDDATE: 值不一致 ('2027-03-02T00:00:00' vs '2034-05-14T00:00:00')
- Result_Data.List[2].COMPACT_NAME: 值不一致 ('新桥三河米饺合同项目' vs '星巴克租赁合同南区')
- Result_Data.List[2].COMPACT_STARTDATE: 值不一致 ('2024-02-01T00:00:00' vs '2025-04-15T00:00:00')
- Result_Data.List[2].DURATION: 值不一致 (4.0 vs 10.0)
- Result_Data.List[2].DURATIONDAY: 类型不一致 (int vs float)，值为 1125 vs 3316.0
- Result_Data.List[2].OPERATE_DATE: 值不一致 ('2024-10-22T14:27:32' vs '2025-06-10T10:28:40')
- Result_Data.List[2].OPERATING_AREA: 类型不一致 (float vs NoneType)，值为 50.0 vs None

原 API 状态: `200`，耗时 `141.57 ms`
新 API 状态: `200`，耗时 `36.65 ms`
...
原 API 状态: `200`，耗时 `117.78 ms`
新 API 状态: `200`，耗时 `19.4 ms`
...
原 API 状态: `200`，耗时 `124.06 ms`
新 API 状态: `200`，耗时 `72.38 ms`
...
原 API 状态: `404`，耗时 `7.36 ms`
新 API 状态: `200`，耗时 `5.63 ms`
...
原 API 状态: `404`，耗时 `6.17 ms`
新 API 状态: `200`，耗时 `51.45 ms`
