...
- 总结果: `PASS 17 / FAIL 69 / SKIP 0 / TOTAL 86`
...
原 API 状态: `200`，耗时 `326.97 ms`
新 API 状态: `200`，耗时 `2304.95 ms`
...
差异明细：
- 新 API 调用失败: ('Connection aborted.', ConnectionResetError(10054, '远程主机强迫关闭了一个现有的连接。', None, 10054, None))

原 API 状态: `200`，耗时 `134.46 ms`
...
原 API 状态: `200`，耗时 `187.16 ms`
新 API 状态: `200`，耗时 `11848.76 ms`
...
差异明细：
- Result_Data.List[0].BUSINESSPROJECT_ID: 值不一致 (119 vs 131)
- Result_Data.List[0].EVALUATE_SCORE: 值不一致 (50.73 vs 48.64)
- Result_Data.List[0].INVESTMENTANALYSIS_ID: 值不一致 (196 vs 474)
- Result_Data.List[0].INVESTMENTDETAIL_ID: 值不一致 (3905 vs 8718)
- Result_Data.List[0].MARKETREVENUE_AVGAMOUNT: 值不一致 (421714.79 vs 462209.15)
- Result_Data.List[0].PROFIT_AMOUNT: 值不一致 (988744.43 vs 944901.36)
- Result_Data.List[0].RECORD_DATE: 值不一致 ('2025-06-06T20:59:06' vs '2025-06-06T21:00:28')
- Result_Data.List[0].REVENUE_AVGAMOUNT: 值不一致 (180860.47 vs 209688.03)
- Result_Data.List[0].REVENUE_TOLERANCE: 值不一致 (0.0 vs 1.89)
- Result_Data.List[0].SERVERPARTSHOP_ID: 值不一致 ('636,637' vs '3670,3671')
- Result_Data.List[0].SERVERPARTSHOP_NAME: 值不一致 ('享当当美食汇' vs '王仁和米线')
- Result_Data.List[0].SERVERPART_AVGRENT: 值不一致 (52639.45 vs 71526.42)
- Result_Data.List[0].SERVERPART_FLOW: 值不一致 (1050908 vs 961000)
- Result_Data.List[0].SERVERPART_ID: 值不一致 (433 vs 431)
- Result_Data.List[0].SERVERPART_NAME: 值不一致 ('官塘服务区' vs '焦岗湖服务区')
- Result_Data.List[0].SERVERPART_REVENUE: 值不一致 (1036230.87 vs 806329.49)
- Result_Data.List[0].VEHICLE_TOLERANCE: 类型不一致 (float vs NoneType)，值为 0.0 vs None
- Result_Data.List[1].BUSINESSPROJECT_ID: 值不一致 (143 vs 1480)
- Result_Data.List[1].EVALUATE_SCORE: 值不一致 (40.8 vs 35.43)
- Result_Data.List[1].INVESTMENTANALYSIS_ID: 值不一致 (196 vs 474)
- Result_Data.List[1].INVESTMENTDETAIL_ID: 值不一致 (3922 vs 8716)
- Result_Data.List[1].MARKETREVENUE_AVGAMOUNT: 值不一致 (367390.96 vs 535292.03)
- Result_Data.List[1].PROFIT_AMOUNT: 值不一致 (487496.72 vs 169361.0)
- Result_Data.List[1].RECORD_DATE: 值不一致 ('2025-06-06T20:59:07' vs '2025-06-06T21:00:28')
- Result_Data.List[1].REVENUE_AVGAMOUNT: 值不一致 (206993.18 vs 118392.33)

原 API 状态: `200`，耗时 `1239.36 ms`
新 API 状态: `200`，耗时 `94.63 ms`
...
差异明细：
- Result_Data.List[0].ADJUST_RATIORANGE: 值不一致 ('28-32.20' vs '28.0-32.2')
- Result_Data.List[0].PROJECT_ENDDATE: 值不一致 ('2027/2/14' vs '2027-02-14T00:00:00')
- Result_Data.List[0].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[1].ADJUST_RATIORANGE: 值不一致 ('28-28.04' vs '28.0-28.04')
- Result_Data.List[1].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[1].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[2].ADJUST_RATIORANGE: 值不一致 ('26' vs '26.0')
- Result_Data.List[2].ADJUST_RENTRANGE: 值不一致 ('138.80' vs '138.8')
- Result_Data.List[2].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[2].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[3].ADJUST_RATIORANGE: 值不一致 ('26' vs '26.0')
- Result_Data.List[3].ADJUST_RENTRANGE: 值不一致 ('47.09-125.40' vs '47.09-125.4')
- Result_Data.List[3].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[3].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[4].ADJUST_RATIORANGE: 值不一致 ('26' vs '26.0')
- Result_Data.List[4].ADJUST_RENTRANGE: 值不一致 ('75.51-125.40' vs '75.51-125.4')
- Result_Data.List[4].PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[4].PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[5].ADJUST_RATIORANGE: 值不一致 ('20-21.52' vs '20.0-21.52')
- Result_Data.List[5].PROJECT_ENDDATE: 值不一致 ('2028/1/13' vs '2028-01-13T00:00:00')
- Result_Data.List[5].PROJECT_STARTDATE: 值不一致 ('2025/1/14' vs '2025-01-14T00:00:00')
- Result_Data.List[6].ADJUST_RATIORANGE: 值不一致 ('20' vs '20.0')
- Result_Data.List[6].PROJECT_ENDDATE: 值不一致 ('2028/1/31' vs '2028-01-31T00:00:00')
- Result_Data.List[6].PROJECT_STARTDATE: 值不一致 ('2018/2/1' vs '2018-02-01T00:00:00')

原 API 状态: `200`，耗时 `112.86 ms`
新 API 状态: `200`，耗时 `45.65 ms`
...
差异明细：
- Result_Data.List[0].children[0].children[0].children[0].node.ADJUST_RATIORANGE: 值不一致 ('28-32.20' vs '28.0-32.2')
- Result_Data.List[0].children[0].children[0].children[0].node.PROFIT_AMOUNT: 值不一致 (-25.71 vs -25.72)
- Result_Data.List[0].children[0].children[0].children[0].node.PROJECT_ENDDATE: 值不一致 ('2027/2/14' vs '2027-02-14T00:00:00')
- Result_Data.List[0].children[0].children[0].children[0].node.PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[0].children[0].children[0].children[0].node.REVENUE_AVGAMOUNT: 值不一致 (14.84 vs 14.85)
- Result_Data.List[0].children[0].children[0].children[0].node.REVENUE_LASTAMOUNT: 值不一致 (342.45 vs 342.46)
- Result_Data.List[0].children[0].children[0].children[1].node.ADJUST_RATIORANGE: 值不一致 ('28-28.04' vs '28.0-28.04')
- Result_Data.List[0].children[0].children[0].children[1].node.PROFIT_AMOUNT: 值不一致 (-13.03 vs -13.04)
- Result_Data.List[0].children[0].children[0].children[1].node.PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[0].children[0].children[0].children[1].node.PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[0].children[0].children[0].children[1].node.REVENUE_AVGAMOUNT: 值不一致 (7.12 vs 7.13)
- Result_Data.List[0].children[0].children[0].children[1].node.REVENUE_LASTAMOUNT: 值不一致 (196.83 vs 196.84)
- Result_Data.List[0].children[0].children[0].children[2].node.ADJUST_RATIORANGE: 值不一致 ('26' vs '26.0')
- Result_Data.List[0].children[0].children[0].children[2].node.ADJUST_RENTRANGE: 值不一致 ('138.80' vs '138.8')
- Result_Data.List[0].children[0].children[0].children[2].node.PROFIT_AMOUNT: 值不一致 (76.47 vs 76.48)
- Result_Data.List[0].children[0].children[0].children[2].node.PROFIT_TOTALAMOUNT: 值不一致 (276.23 vs 276.24)
- Result_Data.List[0].children[0].children[0].children[2].node.PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[0].children[0].children[0].children[2].node.PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')
- Result_Data.List[0].children[0].children[0].children[2].node.REVENUE_AVGAMOUNT: 值不一致 (27.6 vs 27.61)
- Result_Data.List[0].children[0].children[0].children[2].node.REVENUE_LASTAMOUNT: 值不一致 (533.84 vs 533.85)
- Result_Data.List[0].children[0].children[0].children[2].node.ROYALTY_PRICE: 值不一致 (166.74 vs 166.75)
- Result_Data.List[0].children[0].children[0].children[3].node.ADJUST_RATIORANGE: 值不一致 ('26' vs '26.0')
- Result_Data.List[0].children[0].children[0].children[3].node.ADJUST_RENTRANGE: 值不一致 ('47.09-125.40' vs '47.09-125.4')
- Result_Data.List[0].children[0].children[0].children[3].node.PROJECT_ENDDATE: 值不一致 ('2027/3/2' vs '2027-03-02T00:00:00')
- Result_Data.List[0].children[0].children[0].children[3].node.PROJECT_STARTDATE: 值不一致 ('2024/2/1' vs '2024-02-01T00:00:00')

原 API 状态: `200`，耗时 `297.74 ms`
新 API 状态: `200`，耗时 `60.03 ms`
...
原 API 状态: `200`，耗时 `105.47 ms`
新 API 状态: `200`，耗时 `1548.43 ms`
...
- Result_Data.List[0].ACTUAL_RATIO: 值不一致 (50.35 vs 12.06)
- Result_Data.List[0].BUSINESSPROJECT_ID: 值不一致 (668 vs 678)
- Result_Data.List[0].BUSINESSPROJECT_NAME: 值不一致 ('清溪服务区轻餐饮QX-07项目' vs '龙门寺服务区肯德基项目')
- Result_Data.List[0].BUSINESS_TRADE: 值不一致 (215 vs 227)
- Result_Data.List[0].COMMISSION_RATIO: 值不一致 (28.0 vs 20.0)
- Result_Data.List[0].COST_AMOUNT: 值不一致 (616037.93 vs 621853.38)
- Result_Data.List[0].ENDDATE: 类型不一致 (str vs int)，值为 '2024/06/02' vs 20260427
- Result_Data.List[0].GUARANTEERATIO: 值不一致 (41.1 vs 9.3)
- Result_Data.List[0].GUARANTEE_PRICE: 值不一致 (105.0 vs 350.0)
- Result_Data.List[0].MERCHANTS_ID: 值不一致 (-2036 vs -2042)
- Result_Data.List[0].MERCHANTS_NAME: 值不一致 ('桐乡市盛开源高速公路服务区经营管理有限公司' vs '百胜餐饮（安徽）有限公司')
- Result_Data.List[0].MONTH_COUNT: 值不一致 (12.0 vs 8.0)
- Result_Data.List[0].PERIODMONTHPROFIT_ID: 值不一致 (651 vs 9851)
- Result_Data.List[0].PROFIT_AMOUNT: 值不一致 (62341.04 vs 1111828.58)
- Result_Data.List[0].PROFIT_AVG: 值不一致 (10390.17 vs 185304.76)
- Result_Data.List[0].PROFIT_SD: 值不一致 (37405.78 vs 176809.44)
- Result_Data.List[0].PROJECT_ENDDATE: 类型不一致 (str vs int)，值为 '2026/06/02' vs 20330427
- Result_Data.List[0].PROJECT_STARTDATE: 类型不一致 (str vs int)，值为 '2023/06/03' vs 20230428
- Result_Data.List[0].RECORD_DATE: 值不一致 ('2025-05-14T19:25:25' vs '2026-01-07T12:24:39')
- Result_Data.List[0].REVENUE_AMOUNT: 值不一致 (1373523.0 vs 1971489.16)
- Result_Data.List[0].ROYALTY_PRICE: 值不一致 (688560.35 vs 0.0)
- Result_Data.List[0].ROYALTY_THEORY: 值不一致 (691533.94 vs 237807.2)
- Result_Data.List[0].SERVERPARTSHOP_ID: 值不一致 ('1374,1375' vs '1371,1370')
- Result_Data.List[0].SERVERPARTSHOP_NAME: 值不一致 ('桐乡盛开源(粮大年)' vs '肯德基')

原 API 状态: `200`，耗时 `380.53 ms`
新 API 状态: `200`，耗时 `227.36 ms`
...
原 API 状态: `200`，耗时 `12.06 ms`
新 API 状态: `200`，耗时 `6.19 ms`
...
原 API 状态: `200`，耗时 `121.08 ms`
新 API 状态: `200`，耗时 `267.62 ms`
...
差异明细：
- Result_Data.List[0].BUSINESSPROJECT_ID: 值不一致 (1506 vs 1350)
- Result_Data.List[0].BUSINESSPROJECT_NAME: 值不一致 ('新桥服务区丁家馄饨合同项目' vs '')
- Result_Data.List[0].CALCULATE_SELFSHOP: 值不一致 (1 vs 2)
- Result_Data.List[0].EVALUATE_SCORE: 值不一致 (51.85 vs 3.53)
- Result_Data.List[0].EVALUATE_TYPE: 值不一致 (0 vs 6)
- Result_Data.List[0].PROFITCONTRIBUTE_ID: 值不一致 (445 vs 190661)
- Result_Data.List[0].PROFITCONTRIBUTE_PID: 值不一致 (-1 vs 190655)
- Result_Data.List[0].RECORD_DATE: 值不一致 ('2024-11-01T16:30:43' vs '2026-01-07T15:21:48')
- Result_Data.List[0].SABFI_SCORE: 类型不一致 (NoneType vs float)，值为 None vs 3.53
- Result_Data.List[0].SERVERPARTSHOP_ID: 值不一致 ('2383,2382' vs '2046,2047')
- Result_Data.List[0].SERVERPARTSHOP_NAME: 值不一致 ('丁家馄饨' vs '享当当特色美食')
- Result_Data.List[0].SERVERPART_ID: 值不一致 (416 vs 803)
- Result_Data.List[0].SERVERPART_NAME: 值不一致 ('新桥服务区' vs '温泉服务区')
- Result_Data.List[0].STATISTICS_DATE: 值不一致 ('2024/10' vs '2025/07')
- Result_Data.List[1].BUSINESSPROJECT_ID: 值不一致 (1508 vs 1350)
- Result_Data.List[1].CALCULATE_SELFSHOP: 值不一致 (1 vs 2)
- Result_Data.List[1].EVALUATE_SCORE: 值不一致 (9.4 vs 9.07)
- Result_Data.List[1].EVALUATE_TYPE: 值不一致 (1 vs 5)
- Result_Data.List[1].PROFITCONTRIBUTE_ID: 值不一致 (833 vs 190660)
- Result_Data.List[1].PROFITCONTRIBUTE_PID: 值不一致 (446 vs 190655)
- Result_Data.List[1].RECORD_DATE: 值不一致 ('2025-05-14T19:35:38' vs '2026-01-07T15:21:48')
- Result_Data.List[1].SABFI_SCORE: 值不一致 (9.4 vs 9.07)
- Result_Data.List[1].SERVERPARTSHOP_ID: 值不一致 ('2308,2306' vs '2046,2047')
- Result_Data.List[1].SERVERPARTSHOP_NAME: 值不一致 ('丁记米饺' vs '享当当特色美食')
- Result_Data.List[1].SERVERPART_ID: 值不一致 (416 vs 803)

原 API 状态: `200`，耗时 `546.86 ms`
新 API 状态: `200`，耗时 `676.98 ms`
...
原 API 状态: `200`，耗时 `345.77 ms`
新 API 状态: `200`，耗时 `1371.91 ms`
...
原 API 状态: `200`，耗时 `271.23 ms`
新 API 状态: `200`，耗时 `79.57 ms`
...
差异明细：
- Result_Data.List[0].children[0].children[0].node.BUSINESS_ENDDATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.BUSINESS_PERIOD: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.BUSINESS_STARTDATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.Brand_ICO: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.COMMISSION_RATIO: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.COST_RATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.DEPRECIATION_EXPENSE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.DEPRECIATION_YEAR: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.ENDDATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.GUARANTEERATIO: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.LABOURS_COUNT: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.LABOURS_WAGE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.MERCHANTS_ID_Encrypted: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.MINTURNOVER: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.MONTH_COUNT: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.OTHER_EXPENSE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.PERIOD_INDEX: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.PROFIT_RATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.PaymentProgress: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.ProjectProgress: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.RENTFEE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.STARTDATE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.WARNING_CONTENT: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.WARNING_TYPE: 新 API 缺少该字段
- Result_Data.List[0].children[0].children[0].node.COST_AMOUNT: 值不一致 (36109.85 vs 36109.850000000035)

原 API 状态: `200`，耗时 `770.42 ms`
新 API 状态: `200`，耗时 `946.1 ms`
...
原 API 状态: `200`，耗时 `342.59 ms`
新 API 状态: `200`，耗时 `536.86 ms`
...
原 API 状态: `200`，耗时 `167.63 ms`
新 API 状态: `200`，耗时 `2376.68 ms`
...
- Result_Data.List[0].DIALOG_CODE: 值不一致 ('' vs '1b8b6420-4b35-46e2-82a1-2e22d9fe6ac0')
- Result_Data.List[0].OPERATE_DATE: 值不一致 ('2024/10/30 17:59:17' vs '2026/1/21 21:33:03')
- Result_Data.List[0].SENTENCE_CONTENT: 值不一致 ('新桥' vs '111')
- Result_Data.List[0].SENTENCE_ID: 值不一致 (1 vs 6319)
- Result_Data.List[0].SENTENCE_RESULT: 值不一致 ('已标出位置' vs '无法识别。')
- Result_Data.List[0].SENTENCE_STATE: 值不一致 (1 vs 0)
- Result_Data.List[0].SENTENCE_TYPE: 值不一致 (1 vs 0)
...
原 API 状态: `200`，耗时 `138.14 ms`
新 API 状态: `200`，耗时 `91.96 ms`
...
原 API 状态: `200`，耗时 `176.58 ms`
新 API 状态: `200`，耗时 `149.84 ms`
...
- Result_Data.List[0].REVENUE_ACTAMOUNT: 值不一致 (4797970.55 vs 145570.18)
- Result_Data.List[0].REVENUE_ADJAMOUNT: 值不一致 (4907073.93 vs 0.0)
...
- Result_Data.List[0].VEHICLEAMOUNT_ID: 值不一致 (1 vs 65308)
- Result_Data.List[0].VEHICLE_TOTALCOUNT: 值不一致 (296163 vs 0)
- Result_Data.List[1].ADJUST_COUNT: 值不一致 (-1.4 vs -0.29)
- Result_Data.List[1].CONSUMPTION_COEFFICIENT: 值不一致 (0.862729 vs 0.90524)
- Result_Data.List[1].PERCAPITA_INCOME: 值不一致 (26125.0 vs 28763.0)
- Result_Data.List[1].PROVINCE_NAME: 值不一致 ('河南省' vs '湖南省')
- Result_Data.List[1].RECORD_DATE: 值不一致 ('2024-11-15T13:58:29' vs '2025-01-25T12:08:33')
- Result_Data.List[1].REVENUE_ADJAMOUNT: 值不一致 (0.0 vs 12.94)
- Result_Data.List[1].SERVERPART_ID: 值不一致 (416 vs 453)
- Result_Data.List[1].SERVERPART_NAME: 值不一致 ('新桥服务区' vs '砀山服务区')
- Result_Data.List[1].STATISTICS_MONTH: 值不一致 ('2024/08' vs '2024/12')
- Result_Data.List[1].VEHICLEAMOUNT_ID: 值不一致 (9 vs 65303)
- Result_Data.List[1].VEHICLE_ADJAMOUNT: 值不一致 (12.58 vs 2.59)
- Result_Data.List[1].VEHICLE_AMOUNT: 值不一致 (13.98 vs 2.88)
- Result_Data.List[1].VEHICLE_COUNT: 值不一致 (0 vs 5)
- Result_Data.List[2].ADJUST_COUNT: 值不一致 (-1.5 vs -0.29)
- Result_Data.List[2].CONSUMPTION_COEFFICIENT: 值不一致 (0.926901 vs 0.90524)
- Result_Data.List[2].PERCAPITA_INCOME: 值不一致 (30156.0 vs 28763.0)
- Result_Data.List[2].PROVINCE_NAME: 值不一致 ('安徽省' vs '湖南省')

原 API 状态: `200`，耗时 `220.65 ms`
新 API 状态: `200`，耗时 `154.95 ms`
...
原 API 状态: `200`，耗时 `262.84 ms`
新 API 状态: `200`，耗时 `244.62 ms`
...
原 API 状态: `200`，耗时 `159.24 ms`
新 API 状态: `200`，耗时 `10741.17 ms`
...
差异明细：
- Result_Data.List[5].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '351D5C13EE85BB4C' vs None
- Result_Data.List[5].children[1].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '60800641632BC640' vs None
- Result_Data.List[5].children[2].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '1D181B510668D5F8' vs None
- Result_Data.List[5].children[3].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '00CE62DB7C2E1F86' vs None
- Result_Data.List[5].children[4].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '6733DFBB7B9924C9' vs None
- Result_Data.List[5].children[5].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '3B4563EE91B16A95' vs None
- Result_Data.List[5].children[6].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 'D2522BE64E279D08' vs None
- Result_Data.List[5].children[7].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '652F10F80B86CEB6' vs None
- Result_Data.List[5].children[8].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '2BC9FF9E3A936293' vs None
- Result_Data.List[6].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '906D28E2E5E8FDCD' vs None
- Result_Data.List[6].children[1].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '8651F5E1EED78A15' vs None
- Result_Data.List[6].children[2].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '7592B47D69A6B7B5' vs None
- Result_Data.List[7].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '459DF6968D51AB50' vs None
- Result_Data.List[8].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '1775C40FEBB8C1F7' vs None
- Result_Data.List[8].children[1].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '239A2EF001FCAB0C' vs None
- Result_Data.List[9].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '4E2B3A883F814954' vs None
- Result_Data.List[9].children[1].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 'D388C9498207B50F' vs None
- Result_Data.List[10].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '11D680810F57E0B2' vs None
- Result_Data.List[11].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '5B782E82CF47E02A' vs None
- Result_Data.List[12].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '77EA362CA50B1CDF' vs None
- Result_Data.List[13].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 'A1230F2865ADA1E4' vs None
- Result_Data.List[14].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '590EC618D7D07FC6' vs None
- Result_Data.List[15].children[0].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '05395EF93ECCD144' vs None
- Result_Data.List[15].children[1].node.USER_ID_Encrypted: 类型不一致 (str vs NoneType)，值为 '4437A56B7C3ACF8B' vs None

原 API 状态: `200`，耗时 `744.84 ms`
新 API 状态: `200`，耗时 `379.28 ms`
...
| Result_Desc | ✅ | 查询成功 vs 查询成功 |
| Result_Data 类型 | ✅ | dict vs dict |
| Result_Data 字段 | ❌ | ['DOWNLOAD_DATE', 'ISSUPPORTPOINT', 'OPERATE_DATE', 'OWNERUNIT_DESC', 'OWNERUNIT_EN', 'OWNERUNIT_GUID', 'OWNERUNIT_ICO', 'OWNERUNIT_ID', 'OWNERUNIT_INDEX', 'OWNERUNIT_NAME', 'OWNERUNIT_NATURE', 'OWNERUNIT_PID', 'OWNERUNIT_STATE', 'OrganizationList', 'PROVINCE_BUSINESSCODE', 'PROVINCE_CODE', 'STAFF_ID', 'STAFF_NAME', 'ShopList', 'WECHATPUBLICSIGN_ID'] vs ['DOWNLOAD_DATE', 'ISSUPPORTPOINT', 'OPERATE_DATE', 'OWNERUNIT_DESC', 'OWNERUNIT_EN', 'OWNERUNIT_GUID', 'OWNERUNIT_ICO', 'OWNERUNIT_ID', 'OWNERUNIT_INDEX', 'OWNERUNIT_NAME', 'OWNERUNIT_NATURE', 'OWNERUNIT_PID', 'OWNERUNIT_STATE', 'PROVINCE_BUSINESSCODE', 'PROVINCE_CODE', 'STAFF_ID', 'STAFF_NAME', 'WECHATPUBLICSIGN_ID'] |
| 完整响应体(参考) | ✅ | 发现 2 处差异(不影响判定) |

差异明细：
- Result_Data.OrganizationList: 新 API 缺少该字段
- Result_Data.ShopList: 新 API 缺少该字段

原 API 状态: `200`，耗时 `282.24 ms`
新 API 状态: `200`，耗时 `1418.26 ms`
...
| 顶层字段 | ✅ | ['Result_Code', 'Result_Data', 'Result_Desc'] vs ['Result_Code', 'Result_Data', 'Result_Desc'] |
| Result_Code | ❌ | 100 vs 999 |
| Result_Desc | ❌ | 查询成功 vs 查询失败[CODE:-2106]第1 行附近出现错误:
无效的表或视图名[T_OWNERUNITDETAIL] |
| Result_Data 类型 | ❌ | dict vs NoneType |
| 完整响应体(参考) | ✅ | 发现 3 处差异(不影响判定) |
...
- Result_Desc: 值不一致 ('查询成功' vs '查询失败[CODE:-2106]第1 行附近出现错误:\n无效的表或视图名[T_OWNERUNITDETAIL]')

原 API 状态: `200`，耗时 `153.36 ms`
新 API 状态: `200`，耗时 `34.41 ms`
...
原 API 状态: `200`，耗时 `147.46 ms`
新 API 状态: `200`，耗时 `656.95 ms`
...
| PageSize | ✅ | 9 vs 9 |
| List 条数 | ✅ | 1 vs 1 |
| 首条字段集合 | ❌ | 仅原 API: ['OrganizationList', 'ShopList'] | 仅新 API: [] |
| 完整响应体(参考) | ✅ | 发现 3 处差异(不影响判定) |

差异明细：
- Result_Data.List[0].OrganizationList: 新 API 缺少该字段
- Result_Data.List[0].ShopList: 新 API 缺少该字段
- Result_Data.List[0].OWNERUNIT_DESC: 类型不一致 (str vs NoneType)，值为 '' vs None

原 API 状态: `200`，耗时 `216.66 ms`
新 API 状态: `200`，耗时 `60.79 ms`
...
原 API 状态: `200`，耗时 `133.66 ms`
新 API 状态: `200`，耗时 `416.29 ms`
...
原 API 状态: `200`，耗时 `182.31 ms`
新 API 状态: `200`，耗时 `43.27 ms`
...
原 API 状态: `200`，耗时 `118.8 ms`
新 API 状态: `200`，耗时 `6.65 ms`
...
| Result_Data 类型 | ✅ | dict vs dict |
| Result_Data 字段 | ✅ | ['List', 'PageIndex', 'PageSize', 'TotalCount'] vs ['List', 'PageIndex', 'PageSize', 'TotalCount'] |
| TotalCount | ❌ | 32 vs 47644 |
| PageIndex | ✅ | 1 vs 1 |
| PageSize | ✅ | 9 vs 9 |
| List 条数 | ✅ | 9 vs 9 |
| 首条字段集合 | ❌ | 仅原 API: ['BUSINESSMAN_ID', 'COMMODITY_BUSINESS_ID', 'COMMODITY_QTYPE', 'COMMODITY_TYPENAME', 'QUALIFICATIONList', 'QUALIFICATION_ENDDATE', 'QUALIFICATION_ENDDATE_End', 'QUALIFICATION_ENDDATE_Start', 'QUALIFICATION_ID', 'SERVERPARTSHOP_IDS', 'SERVERPART_NAME', 'STAFF_ID', 'STAFF_NAME', 'UPPER_STATE'] | 仅新 API: ['ADDTIME', 'BUSINESSAPPROVAL_ID', 'BUSINESSTYPE', 'CANSALE', 'COMMODITY_ALLNAME', 'COMMODITY_BRAND', 'COMMODITY_CODE', 'COMMODITY_COUNT', 'COMMODITY_CURRPRICE', 'COMMODITY_EN', 'COMMODITY_FROZENCOUNT', 'COMMODITY_GROUPPRICE', 'COMMODITY_HOTKEY', 'COMMODITY_ID', 'COMMODITY_MAXPRICE', 'COMMODITY_MINPRICE', 'COMMODITY_ORIPRICE', 'COMMODITY_PROMOTIONPRICE', 'COMMODITY_SERVERCODE', 'COMMODITY_SYMBOL', 'COMMODITY_UNIFORMPRICE', 'ISBULK', 'PROVINCE_CODE', 'USERDEFINEDTYPE_ID'] |
| 完整响应体(参考) | ✅ | 发现 25 处差异(不影响判定) |

差异明细：
- Result_Data.List[0].BUSINESSMAN_ID: 新 API 缺少该字段
- Result_Data.List[0].COMMODITY_BUSINESS_ID: 新 API 缺少该字段
- Result_Data.List[0].COMMODITY_QTYPE: 新 API 缺少该字段
- Result_Data.List[0].COMMODITY_TYPENAME: 新 API 缺少该字段
- Result_Data.List[0].QUALIFICATIONList: 新 API 缺少该字段
- Result_Data.List[0].QUALIFICATION_ENDDATE: 新 API 缺少该字段
- Result_Data.List[0].QUALIFICATION_ENDDATE_End: 新 API 缺少该字段
- Result_Data.List[0].QUALIFICATION_ENDDATE_Start: 新 API 缺少该字段
- Result_Data.List[0].QUALIFICATION_ID: 新 API 缺少该字段
- Result_Data.List[0].SERVERPARTSHOP_IDS: 新 API 缺少该字段
- Result_Data.List[0].SERVERPART_NAME: 新 API 缺少该字段
- Result_Data.List[0].STAFF_ID: 新 API 缺少该字段
- Result_Data.List[0].STAFF_NAME: 新 API 缺少该字段
- Result_Data.List[0].UPPER_STATE: 新 API 缺少该字段
- Result_Data.List[0].ADDTIME: 新 API 多出该字段
- Result_Data.List[0].BUSINESSAPPROVAL_ID: 新 API 多出该字段
- Result_Data.List[0].BUSINESSTYPE: 新 API 多出该字段
- Result_Data.List[0].CANSALE: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_ALLNAME: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_BRAND: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_CODE: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_COUNT: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_CURRPRICE: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_EN: 新 API 多出该字段
- Result_Data.List[0].COMMODITY_FROZENCOUNT: 新 API 多出该字段

原 API 状态: `200`，耗时 `126.37 ms`
新 API 状态: `200`，耗时 `1115.68 ms`
...
原 API 状态: `200`，耗时 `152.82 ms`
新 API 状态: `200`，耗时 `216.73 ms`
...
原 API 状态: `200`，耗时 `271.71 ms`
新 API 状态: `200`，耗时 `385.93 ms`
...
原 API 状态: `404`，耗时 `9.24 ms`
新 API 状态: `200`，耗时 `8.51 ms`
...
原 API 状态: `200`，耗时 `43.14 ms`
新 API 状态: `200`，耗时 `10.33 ms`
...
原 API 状态: `404`，耗时 `12.5 ms`
新 API 状态: `200`，耗时 `10.58 ms`
...
| Result_Code | ❌ | None vs 999 |
| Result_Desc | ❌ | None vs 查询失败未将对象引用设置到对象的实例。 |
| Result_Data 类型 | ✅ | NoneType vs NoneType |
| 完整响应体(参考) | ✅ | 发现 4 处差异(不影响判定) |
...
原 API 状态: `500`，耗时 `5.88 ms`
新 API 状态: `200`，耗时 `11.36 ms`
...
原 API 状态: `500`，耗时 `4.46 ms`
新 API 状态: `200`，耗时 `18.68 ms`
...
原 API 状态: `500`，耗时 `30.19 ms`
新 API 状态: `200`，耗时 `6.53 ms`
...
原 API 状态: `404`，耗时 `19.54 ms`
新 API 状态: `200`，耗时 `984.48 ms`
...
原 API 状态: `404`，耗时 `21.14 ms`
新 API 状态: `200`，耗时 `693.57 ms`
...
原 API 状态: `404`，耗时 `341.26 ms`
新 API 状态: `200`，耗时 `45.03 ms`
...
原 API 状态: `404`，耗时 `12.06 ms`
新 API 状态: `405`，耗时 `6.51 ms`
...
原 API 状态: `404`，耗时 `34.37 ms`
新 API 状态: `200`，耗时 `7.0 ms`
...
原 API 状态: `404`，耗时 `10.18 ms`
新 API 状态: `200`，耗时 `21.1 ms`
...
原 API 状态: `200`，耗时 `396.82 ms`
新 API 状态: `200`，耗时 `1254.57 ms`
...
原 API 状态: `200`，耗时 `228.36 ms`
新 API 状态: `200`，耗时 `455.42 ms`
...
原 API 状态: `404`，耗时 `10.56 ms`
新 API 状态: `200`，耗时 `7.64 ms`
...
原 API 状态: `200`，耗时 `8.74 ms`
新 API 状态: `200`，耗时 `7.38 ms`
...
原 API 状态: `404`，耗时 `28.43 ms`
新 API 状态: `200`，耗时 `8.84 ms`
...
原 API 状态: `404`，耗时 `5.92 ms`
新 API 状态: `200`，耗时 `9.69 ms`
...
原 API 状态: `200`，耗时 `12.26 ms`
新 API 状态: `200`，耗时 `9.16 ms`
...
原 API 状态: `404`，耗时 `6.16 ms`
新 API 状态: `405`，耗时 `6.89 ms`
