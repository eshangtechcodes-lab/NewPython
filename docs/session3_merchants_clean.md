...
原 API 状态: `200`，耗时 `157.82 ms`
新 API 状态: `200`，耗时 `2091.99 ms`
...
原 API 状态: `200`，耗时 `136.22 ms`
新 API 状态: `200`，耗时 `13.23 ms`
...
原 API 状态: `200`，耗时 `119.32 ms`
新 API 状态: `200`，耗时 `30.82 ms`
...
原 API 状态: `200`，耗时 `87.24 ms`
新 API 状态: `200`，耗时 `10.89 ms`
...
原 API 状态: `404`，耗时 `3.77 ms`
新 API 状态: `200`，耗时 `3.14 ms`
...
原 API 状态: `415`，耗时 `3.45 ms`
新 API 状态: `200`，耗时 `24.02 ms`
